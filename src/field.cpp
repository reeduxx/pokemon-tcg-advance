...
Field::Field() : m_bg(bn::regular_bg_items::field.create_bg()), m_scroll_curr(0, -48), m_scroll_target(0, -48) {
...
const Zone& Field::get_zone(int i) const {
	return m_zones[i];
}

Zone& Field::get_zone(int i) {
	return m_zones[i];
}
